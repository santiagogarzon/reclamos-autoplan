    ...
    <section className="seo-hero">
      <div className="wrap">
        <nav aria-label="breadcrumb" className="breadcrumb">
          ...
          <span aria-current="page">{title.slice(0, 50)}</span>
        </nav>

        <span className="eyebrow on-dark" style={{ marginBottom: "24px" }}>{eyebrow}</span>
        ...
        <div className="sh-cta">
          <WhatsAppLink location="seo_hero" className="btn btn-wa btn-lg">
            {WA_SVG}
            {ctaLabel}
          </WhatsAppLink>
