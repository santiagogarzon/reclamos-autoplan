...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-[#0B1120]/90 backdrop-blur-md border-b border-white/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1DAE56] text-white text-sm font-semibold px-4 py-2 rounded-lg transition-all duration-200 shadow-lg shadow-green-900/30 hover:scale-[1.02]"
          >
            <WhatsAppIcon />
            Consultar gratis
          </a>
...
function ScaleIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white" aria-hidden="true">
      <path d="M12 3v3m0 0L9 9m3-3 3 3M3 20h18M5 20l2-4m10 4-2-4M9 12l-2 4M15 12l2 4M9 12h6M5 20l2-8 5 4 5-4 2 8" />
    </svg>
  );
}
