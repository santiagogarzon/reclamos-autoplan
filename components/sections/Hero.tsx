        ...
        <div className="hero-grid">
          ...
          <div>
            <div className="hero-eyebrow">
              <span className="eyebrow">Abogado especializado en autoplanes</span>
            </div>
            <h1>
            ...
            <p className="hero-lead">
              Si ya pagaste tus cuotas y no entregaron el vehículo, tenés derecho a
              reclamar. Más de {SITE_CONFIG.successCases} casos favorables en toda Argentina.
            </p>
            <div className="hero-cta">
              ...
              <a href="#casos" className="btn btn-ghost btn-lg">
          ...
          <div className="portrait-wrap reveal">
            ...
            <div className="portrait-badge">
              <span className="pb-num">+{SITE_CONFIG.successCases}</span>
              <span className="pb-rule" />
              <span className="pb-label">casos<br />favorables</span>
            </div>
          </div>
        </div>
      </div>
